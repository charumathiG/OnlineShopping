...
exec[dbo].[CustomerRegistration] 'Navin','9942389666','44337','navin@gmail.com','NO.2 Kamaraj Nagar,Chennai-97'
...
GO
PRINT N'Creating [dbo].[SP_PaymentType]...';


GO
CREATE PROCEDURE [dbo].[SP_PaymentType]
(
@PaymentMode varchar(20)
)
as
begin
select * from Payment where Paymentmode = @PaymentMode
end
GO
...
create table Customers(
  ...
  CustomerEmail varchar(100)not null CHECK(CustomerEmail LIKE '%___@___%') ,
